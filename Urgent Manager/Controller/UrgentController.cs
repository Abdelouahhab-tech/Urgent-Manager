    ...
    public class UrgentController : UserController
    {
        ...
        public void InsertUrgent(UrgentModel urgent)
        {
            try
            {
                ...
                string QUERY = "INSERT INTO Urgent (UrgentUnico,DateUrgent,HUrgent,Shift,UrgentStatus,Alimentation,UserFinished,FinishedDate) VALUES(@Urgent,@Date,@time,@Shift,@Status,@Alimentation,@UserFinished,@FinishedDate)";
